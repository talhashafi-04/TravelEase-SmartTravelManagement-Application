...
namespace DatabaseProject
{
    public partial class Form2 : Form  
    {
        ...
        private readonly SqlConnection con = new SqlConnection(@"Data Source=TALHA-SHAFI\SQLEXPRESS;Initial Catalog=TravelEase;Integrated Security=True;Encrypt=False;");
